...
#define TOK_IDENTIFICADORERROR 296
...
{
       0,    85,    85,    86,    90,    93,    94,    95,    96,    97,
      98,    99,   100,   101,   102,   103,   104,   105,   106,   107,
     108,   109,   110,   111,   112,   113,   114,   115,   116,   117,
     118,   119,   120,   121,   122,   123,   124,   150,   151,   152,
     153,   154,   155,   156,   160,   161,   162,   163,   164,   165,
     166,   167,   168,   169,   193,   198,   199,   200,   201,   202,
...
static const char *const yytname[] =
{
  ...
  "TOK_MENOR", "TOK_MAYOR", "TOK_CONSTANTE_ENTERA", "TOK_IDENTIFICADOR",
  "TOK_TRUE", "TOK_FALSE", "TOK_ERROR", "TOK_IDENTIFICADORERROR",
  "$accept", "programa", "escritura1", "escritura2", "declaraciones",
...
{
      14,     0,    45,    31,   -39,   -39,   -39,     5,   -39,    31,
       9,   -39,   -39,   -39,    29,    48,   -39,    49,    58,    37,
       5,   -39,    48,     9,   -39,   -39,    55,    38,    -5,   -39,
     -39,   -39,    61,    64,    65,    66,    47,    47,    -7,    71,
      -5,    68,   -39,   -39,    80,   -39,   -39,   -39,   -39,   -39,
       5,    47,    47,   -39,    47,    47,    47,    -2,   -39,   -39,
     -39,    34,   -39,   -39,   -39,    34,    47,    47,   -39,   -39,
     -39,    47,    67,    88,    94,    70,   109,    90,    92,    -1,
     -39,    47,    47,    47,    47,    47,    47,    47,   119,    34,
      34,   -39,    99,     5,   -39,   120,   121,   -39,    47,    47,
      47,    47,    47,    47,   -39,    16,    93,    -1,    -1,   -39,
     -39,     4,   104,   -39,    31,    94,    -5,    -5,    34,    34,
      34,    34,    34,    34,    47,   -39,   -39,   -39,    -5,   -39,
      91,   118,    16,   127,   140,   -39,   -39,   -39,   130,    -5,
     131,   -39
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,     8,    10,     9,     0,    17,     6,    14,     0,     0,
       0,     4,    17,     0,     7,    73,     0,     0,     0,    16,
      15,    13,     0,     0,     0,     0,     0,     0,     0,     0,
      26,     0,    29,    30,     0,    34,    35,    31,    32,    33,
      20,     0,     0,    42,     0,     0,     0,    53,    71,    72,
      57,    43,    54,    69,    70,    44,     0,     0,     2,    27,
      28,     0,     0,     0,    22,     0,     0,     0,     0,    49,
      52,    60,     0,     0,     0,     0,     0,     0,     0,    36,
      37,    23,     0,     0,    19,     0,     0,    55,     0,     0,
       0,     0,     0,     0,    56,    62,     0,    45,    46,    47,
      48,    50,    51,    38,    25,    22,     0,     0,    63,    64,
      65,    66,    67,    68,     0,    59,    58,    24,     0,    21,
       0,     0,    62,     0,    39,    41,    61,    18,     0,     0,
       0,    40
};
...
{
     -39,   -39,   -39,   -39,    -8,   -39,   -39,   -39,     6,   -39,
     128,   132,   -39,   -39,    40,    60,   -39,   -38,   -39,   -39,
     -39,   -39,   -28,   -39,   -39,   -39,   -39,   -39,   -33,   -39,
      24,   -39,   -39,   -39,   138
};
...
static const yytype_int16 yydefgoto[] =
{
      ...
      18,    21,    22,    73,    94,    74,   128,    39,    40,    41,
      42,    43,    60,    45,    46,    47,    48,    49,    61,   106,
     125,    78,    62,    63,    64
};
...
{
      44,    16,    69,    33,    65,    34,    35,    36,    37,     5,
       6,    66,    44,    14,    81,    67,    66,     1,    75,    76,
       3,    77,    79,    80,    84,    85,    27,    82,    83,    84,
      85,   124,    38,    88,    89,     5,     6,     7,    90,    82,
      83,    84,    85,    86,    87,     4,    17,    19,   105,   107,
     108,   109,   110,   111,   112,    20,    72,    82,    83,    84,
      85,    86,    87,    54,    23,   118,   119,   120,   121,   122,
     123,    55,    24,    25,    31,    32,    56,    50,   130,   131,
      51,    52,    70,    25,    57,    58,    59,    95,    44,    44,
     133,   132,    68,    82,    83,    84,    85,    86,    87,    72,
      44,   140,    71,    53,    91,    92,   127,    97,    93,   104,
     126,    44,   134,    82,    83,    84,    85,    86,    87,   114,
      98,    99,   100,   101,   102,   103,    96,    82,    83,    84,
      85,    86,    82,    83,    84,    85,    86,    87,   113,   135,
     116,   117,    82,    83,    84,    85,    86,    87,   137,   138,
     139,    30,   141,   115,    29,   129,   136,    26
};

static const yytype_uint8 yycheck[] =
{
      28,     9,    40,     8,    37,    10,    11,    12,    13,     4,
       5,    18,    40,     7,    16,    22,    18,     3,    51,    52,
      20,    54,    55,    56,    25,    26,    20,    23,    24,    25,
      26,    15,    37,    66,    67,     4,     5,     6,    71,    23,
      24,    25,    26,    27,    28,     0,    37,    18,    81,    82,
      83,    84,    85,    86,    87,     7,    50,    23,    24,    25,
      26,    27,    28,    16,    15,    98,    99,   100,   101,   102,
     103,    24,    14,    36,    19,    37,    29,    16,   116,   117,
      16,    16,    14,    36,    37,    38,    39,    17,   116,   117,
     128,   124,    21,    23,    24,    25,    26,    27,    28,    93,
     128,   139,    22,    37,    37,    17,   114,    17,    14,    17,
      17,   139,    21,    23,    24,    25,    26,    27,    28,    20,
      30,    31,    32,    33,    34,    35,    17,    23,    24,    25,
      26,    27,    23,    24,    25,    26,    27,    28,    19,    21,
      20,    20,    23,    24,    25,    26,    27,    28,    21,     9,
      20,    23,    21,    93,    22,   115,   132,    19
};
...
static const yytype_uint8 yystos[] =
{
      ...
      48,    49,    50,    51,    50,    44,    46,    37,    52,    18,
       7,    53,    54,    15,    14,    36,    76,    50,    45,    53,
      52,    19,    37,     8,    10,    11,    12,    13,    37,    59,
      60,    61,    62,    63,    64,    65,    66,    67,    68,    69,
      16,    16,    16,    37,    16,    24,    29,    37,    38,    39,
      64,    70,    74,    75,    76,    70,    18,    22,    21,    59,
      14,    22,    50,    55,    57,    70,    70,    70,    73,    70,
      70,    16,    23,    24,    25,    26,    27,    28,    70,    70,
      70,    37,    17,    14,    56,    17,    17,    17,    30,    31,
      32,    33,    34,    35,    17,    70,    71,    70,    70,    70,
      70,    70,    70,    19,    20,    57,    20,    20,    70,    70,
      70,    70,    70,    70,    15,    72,    17,    46,    58,    56,
      59,    59,    70,    59,    21,    21,    72,    21,     9,    20,
      59,    21
};
...
#line 99 "alfa.y" /* yacc.c:1646  */
    {tipo_actual=ENTERO; fprintf(out, ";R10:\t<tipo> ::= int\n");}
#line 1472 "y.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 100 "alfa.y" /* yacc.c:1646  */
    {tipo_actual=BOOLEANO; fprintf(out, ";R11:\t<tipo> ::= boolean\n");}
...
#line 108 "alfa.y" /* yacc.c:1646  */
    {fprintf(out, ";R23:\t<parametros_funcion> ::=\n");}
...
#line 124 "alfa.y" /* yacc.c:1646  */
    {
              if(ambito_actual == GLOBAL){
                simbolo_actual = usoGlobal((yyvsp[-2].atributos).lexema);
              }
              else{
                simbolo_actual = usoLocal((yyvsp[-2].atributos).lexema);
              }
              if(simbolo_actual == NULL){
                printf("****Error semantico en lin %ld: Acceso a variable no declarada(<%s>).", nlin, (yyvsp[-2].atributos).lexema);
                return -1;
              }
              ...
              if(simbolo_actual->tipo != (yyvsp[0].atributos).tipo){
                printf("****Error semantico en lin %ld: Asignacion incompatible.", nlin);
                return -1;
              }
...
#line 169 "alfa.y" /* yacc.c:1646  */
    {
         if(ambito_actual == GLOBAL){
           simbolo_actual = usoGlobal((yyvsp[0].atributos).lexema);
         }
         else{
           simbolo_actual = usoLocal((yyvsp[0].atributos).lexema);
         }
         if(simbolo_actual == NULL){
           printf("****Error semantico en lin %ld: Acceso a variable no declarada(<%s>).", nlin, (yyvsp[0].atributos).lexema);
           return -1;
         }
         if(simbolo_actual->cat_simbolo == FUNCION){
         ...
         (yyval.atributos).tipo=simbolo_actual->tipo;
         (yyval.atributos).es_direccion=VARIABLE;
         escribir_operando(out, (yyvsp[0].atributos).lexema, VARIABLE);
...
#line 220 "alfa.y" /* yacc.c:1646  */
  ...
  escribir_operando(out, (yyvsp[0].atributos).lexema, INMEDIATO);
